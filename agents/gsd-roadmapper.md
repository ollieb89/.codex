...
Reference full template: `/home/ollie/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ollie/.config/opencode/get-shit-done/templates/state.md`.

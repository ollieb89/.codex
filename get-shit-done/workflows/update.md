...
if [ -f ./.opencode/get-shit-done/VERSION ]; then
  ...
  echo "LOCAL"
elif [ -f /home/ollie/.config/opencode/get-shit-done/VERSION ]; then
  cat /home/ollie/.config/opencode/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/home/ollie/.config/opencode/` for global, `./.opencode/` for local)
...
**If GLOBAL install:**
```bash
rm -f /home/ollie/.config/opencode/cache/gsd-update-check.json
```

...
```bash
INIT=$(node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs init milestone-op)
```
...
```bash
CHECKER_MODEL=$(node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs resolve-model gsd-integration-checker --raw)
```
...
node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs phases list
```
...
PHASE_INFO=$(node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs find-phase 01 --raw)
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs summary-extract "$summary" --fields requirements_completed | jq -r '.requirements_completed'
done
```

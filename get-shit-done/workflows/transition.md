...
```bash
TRANSITION=$(node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
...
```bash
node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs config-set workflow.auto_advance false
```

...
```bash
node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs validate health $REPAIR_FLAG
```
...
```bash
node /home/ollie/.config/opencode/get-shit-done/bin/gsd-tools.cjs validate health
```
